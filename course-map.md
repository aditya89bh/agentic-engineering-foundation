...
| 2 | Structured Outputs and Schema Design | Define, validate, and recover machine-readable model outputs | Planned |
...
Day 1 supplies the mental model used throughout: a controller repeatedly chooses an action, the environment returns an observation, and deterministic code updates state and enforces the stopping policy.
